...
/**
 * OccupancyApi Class Doc Comment
 *
 * @category Class
 * @package  Abulia\TflUnified\Swagger
 * @author   Swagger Codegen team
...
class OccupancyApi
{
    ...
    {
        list($response) = $this->occupancyGetWithHttpInfo();
        return $response;
    }

    /**
     * Operation occupancyGetWithHttpInfo
     *
     * Gets the occupancy for all car parks that have occupancy data
     *
     * @throws \Abulia\TflUnified\Swagger\ApiException on non-2xx response
     * @return array of \Abulia\TflUnified\Swagger\Model\CarParkOccupancy[], HTTP status code, HTTP response headers (array of strings)
     */
    public function occupancyGetWithHttpInfo()
    {
        // parse inputs
        $resourcePath = "/Occupancy/CarPark";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Abulia\TflUnified\Swagger\Model\CarParkOccupancy[]',
                '/Occupancy/CarPark'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Abulia\TflUnified\Swagger\Model\CarParkOccupancy[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Abulia\TflUnified\Swagger\Model\CarParkOccupancy[]', $e->getResponseHeaders());
     ...
     * @return \Abulia\TflUnified\Swagger\Model\CarParkOccupancy
     */
    public function occupancyGetById($id)
    {
        list($response) = $this->occupancyGetByIdWithHttpInfo($id);
        return $response;
    }

    /**
     * Operation occupancyGetByIdWithHttpInfo
     *
     * Gets the occupancy for a car park with a given id
     *
     * @param string $id  (required)
     ...
     * @return array of \Abulia\TflUnified\Swagger\Model\CarParkOccupancy, HTTP status code, HTTP response headers (array of strings)
     */
    public function occupancyGetByIdWithHttpInfo($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling occupancyGetById');
        }
        // parse inputs
        $resourcePath = "/Occupancy/CarPark/{id}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
