...
/**
 * TimeAdjustment Class Doc Comment
 *
 * @category    Class
 * @package     Abulia\TflUnified\Swagger
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class TimeAdjustment implements ArrayAccess, Jsonable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TimeAdjustment';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['time_is'] = isset($data['time_is']) ? $data['time_is'] : null;
     ...
     * @return string
     */
    public function getTimeIs()
    {
        return $this->container['time_is'];
    }

    /**
     * Sets time_is
     * @param string $time_is
     * @return $this
     */
    public function setTimeIs($time_is)
    {
        $this->container['time_is'] = $time_is;
